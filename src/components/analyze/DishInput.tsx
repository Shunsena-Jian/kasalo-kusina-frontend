...
export const DishInput: React.FC<DishInputProps> = ({
    ...
    return (
        <div className="w-full space-y-4 relative">
            ...
            {imageFeaturesDisabled && (
                <div
                    className="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-3 rounded-md text-sm"
                    role="alert"
                >
                    <p>
                        <span className="font-bold">Note:</span> Image upload is disabled. This
                        feature requires a Gemini API key with billing enabled. You can continue
